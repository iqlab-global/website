          ...
          <div className={s.wrapper}>
            ...
            <div className={s.headingAndTexts}>
              ...
              <div className={s.texts}>
                <p>
                  Let’s build something amazing together. Whether you have a project in mind, need guidance,
                  or just want to learn more about us, we’re here to help.
                </p>
                <p>
                  Have a question or need support? We’re just a message away. Fill out the form below, and
              ...
              <div className={s.inputs}>
                <form onSubmit={handleSubmit}>
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                  />
                  <Input id="company" heading="Company" value={formData.company} onChange={handleChange} />
                  <Input
                    isTextarea
                    className={s.message}
                    id="message"
                  ...
                  <div className={s.captchaSection}>
                    ...
                    />
                    <Button className={s.submitBtn} disabled={loading || !formData.email} type="submit">
            ...
            <div className={s.companyContacts}>
              ...
              <div className={s.contactsWrapper}>
                <p className={s.description}>
                  Stay connected with us through various channels. Your journey starts with a conversation.
                </p>
